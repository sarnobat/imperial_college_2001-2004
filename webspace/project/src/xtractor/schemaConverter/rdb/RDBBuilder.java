...
public class RDBBuilder {
	 ...
	 * @param schemaFile
	 */
	public RDBBuilder(XERModel xerModel, File schemaFile, Writer out, String comment) {
		this.model = xerModel;
		this.out = out;
	...
	public void build() throws IOException {
		...
		out.write("INSERT INTO XTractor_schemas(name,comment) VALUES ('" + schemaName + "','"+comment+"');\n");
