<?
	...
	$sell = array(0,0,0,0,0,0,0,0);			// PutOnMarket
	$takeOff = array(0,0,0,0,0,0,0,0);		// TakeOffMarket
	$cost = array(0,0,0,0,0,0,0,0);

	$forsale= array(0,0,0,0,0,0,0,0);

	/***************************************************************************************/
	/* The values that are read into the arrays have all been validated in home_planet.php */
...
//			echo "$new <br>";
	...
	echo "<meta http-equiv=Refresh content=\"0.000000000000000000000001; URL=home_planet.php \"> ";
