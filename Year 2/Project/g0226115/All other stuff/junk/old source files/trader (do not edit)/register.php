...
//	include "header.php";
	...
	{/* Specified username is already in use */
		...
		echo "<meta http-equiv=Refresh content=\"2; URL= login.html \">" ; // This line redirects you to the Logging in Page
	}
	else
	{/* Specified username is acceptable for registration */
		...
		echo "<meta http-equiv=Refresh content=\"0.1; URL= selectplanet.php \">";
	}
