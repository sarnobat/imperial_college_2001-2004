// DO NOT HAVE A SEPARATE FILE FOR THIS<?
	
	include "dbconnect.cgi";
	
	// Find out the co-ordinates of your home planet
	$x = $_COOKIE["x_home"];
	$y = $_COOKIE["y_home"];
	$z = $_COOKIE["z_home"];
	...
	if (newmileage < 0){
		// alert user that the ship's mileage will be exceed and that a new ship must be bought;
	}
