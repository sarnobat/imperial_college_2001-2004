...
<%
		...
		out.println("<td align=center bgcolor=\"#0033CC\"><a href=\"category.jsp?category="  + category + "&shopperid=" + userid + "\"><font color=\"C0C0C0\">"+ category + "</font></a></td>");//+ "&shopperid=" + userid 
		}
