 ...
 */
	...
	{
		//This statement would have been added to satisfy the AbstractImplementation assertion
		//abstract = Ord[Bool].first => #implements = 0
	}
	...
	fun Add(s,s':System,
		...
		//TODO:Don't you decrement the maxPlugs count here?
	...
	/**
	 * QUESTION 4 - WORKS, BUT DOESN'T MAKE USE OF ADD WHICH IS SURELY REQUIRED
	 * You cannot use evolve to do this because you cannot specify the states as arguments
	 * Use of Add to specify this was attempted, but to no avail
	 */
