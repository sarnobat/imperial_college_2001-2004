...
public class XEREntityParser extends XERAbstractParser {
	...
	private String createDataTable(XEREntity xerEntity) throws IOException, EntityNotParsedException, ForeignTableException {
		...
		//Collection attributeSystemInformation = new LinkedList();;
		...
		if (xerEntity instanceof XERMixedEntity) {
			...
			//mixedEntityMetaEntry = systemTableHandler.addMixedEntity(xerEntity);
		}
		...
		for (Iterator iter = attributes.iterator(); iter.hasNext();) {
			...
			try {
				...
				/*attributeSystemInformation.add(systemTableHandler.insertAttribute(attribute.getName(),xerEntity.getName(),null));
				systemTableHandler.addPendingDataInsertions(attributeSystemInformation);*/
