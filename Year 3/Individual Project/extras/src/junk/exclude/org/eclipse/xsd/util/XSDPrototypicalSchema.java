 ...
 * </copyright>
 *
 * plugins/org.eclipse.xsd/src/org/eclipse/xsd/util/XSDPrototypicalSchema.java, xsd, org.eclipse.dev, 20020724_0754SL
 * @version 1.4 7/24/02
 */
 ...
 *   </li>
 *   <li>
 *     and {@link #traceLoading tracing} a resource set's loading behavior when loading a URI.
 *   </li>
 * </ol>
 * </p>
 */
public class XSDPrototypicalSchema {
	...
	// <!-- begin-initialize-prototype-schema -->
	{
		// Create the schema, give it a target namespace, and set its form defaults.
		//
		prototypeSchema = xsdFactory./*{@link XSDFactory#createXSDSchema */
		createXSDSchema /*}*/
		 ();
		prototypeSchema./*{@link XSDSchema#setTargetNamespace */
		setTargetNamespace /*}*/
		 ("http://www.example.com/PrototypicalSchema");
		prototypeSchema./*{@link XSDSchema#setElementFormDefault */
		setElementFormDefault /*}*/
		 (XSDForm.QUALIFIED_LITERAL);
		prototypeSchema./*{@link XSDSchema#setAttributeFormDefault */
		...
		// which is recommend, this is the recommended qualifier.
		//
		prototypeSchema./*{@link XSDSchema#setSchemaForSchemaQNamePrefix */
		...
		// and some other imported namespace.
		//
		Map qNamePrefixToNamespaceMap = prototypeSchema./*{@link XSDSchema#getQNamePrefixToNamespaceMap */
		getQNamePrefixToNamespaceMap /*}*/
		 ();
		qNamePrefixToNamespaceMap.put("PTS", prototypeSchema.getTargetNamespace());
		qNamePrefixToNamespaceMap.put(prototypeSchema.getSchemaForSchemaQNamePrefix(), /*{@link */
		XSDConstants /*}*/
		.SCHEMA_FOR_SCHEMA_URI_2001);
		qNamePrefixToNamespaceMap.put("EXT", /*{@link #*/
		someOtherSchemaURI /*}*/
		);
	...
	// <!-- begin-initialize-some-other-import -->
	{
		// Create an import and set its namespace and schema location.
		//
		XSDImport someOtherImport = xsdFactory./*{@link XSDFactory#createXSDImport */
		createXSDImport /*}*/
		 ();
		someOtherImport./*{@link XSDImport#setNamespace */
		setNamespace /*}*/
		 (/*{@link #*/
		someOtherSchemaURI /*}*/
		);
		someOtherImport./*{@link XSDImport#setSchemaLocation */
		setSchemaLocation /*}*/
		 (someOtherSchemaURI);

		// Add the import to the schema contents.
		//
		prototypeSchema./*{@link XSDSchema#getContents */
		getContents /*}*/
		 ().add(someOtherImport);
	 ...
	 *  simpleAttributeDeclarationGroupMember.{@link XSDAttributeDeclaration#setConstraint setConstraint}({@link XSDConstraint}.DEFAULT_LITERAL);
	 *  simpleAttributeDeclarationGroupMember.{@link XSDAttributeDeclaration#setLexicalValue setLexicalValue}("defaultValue");
	 *
	...
	// <!-- begin-initialize-simple-attribute-group-definition -->
	{
		...
		simpleAttributeGroupDefinition = xsdFactory.createXSDAttributeGroupDefinition();
		simpleAttributeGroupDefinition./*{@link XSDNamedComponent#getName */
		setName /*}*/
		 ("simpleAttributeGroupDefinition");
		...
		simpleAttributeDeclarationGroupMember = xsdFactory.createXSDAttributeDeclaration();
		simpleAttributeDeclarationGroupMember./*{@link XSDNamedComponent#setName */
		setName /*}*/
		 ("simpleAttributeDeclarationGroupMember");
		simpleAttributeDeclarationGroupMember./*{@link XSDAttributeDeclaration#setTypeDefinition */
		setTypeDefinition /*}*/
		 (prototypeSchema./*{@link XSDConcreteComponent#resolveSimpleTypeDefinition(String, String) */
		resolveSimpleTypeDefinition /*}*/
		 (/*{@link #*/
		someOtherSchemaURI /*}*/
		, "someOtherTypeDefinition"));
		simpleAttributeDeclarationGroupMember./*{@link XSDAttributeDeclaration#setConstraint */
		setConstraint /*}*/
		 (/*{@link */
		XSDConstraint /*}*/
		.DEFAULT_LITERAL);
		simpleAttributeDeclarationGroupMember./*{@link XSDAttributeDeclaration#setLexicalValue */
		setLexicalValue /*}*/
		 ("defaultValue");
		...
		/*{@link */
		XSDAttributeUse /*}*/
		simpleAttributeUseGroupMember = xsdFactory.createXSDAttributeUse();
		simpleAttributeUseGroupMember./*{@link XSDAttributeUse#setContent */
		setContent /*}*/
		 (simpleAttributeDeclarationGroupMember);
		simpleAttributeGroupDefinition./*{@link XSDAttributeGroupDefinition#getContents */
		getContents /*}*/
		...
		prototypeSchema./*{@link XSDSchema#getContents */
		getContents /*}*/
		 ().add(simpleAttributeGroupDefinition);
	...
	// <!-- begin-initialize-simple-recursive-model-group-definition -->
	{
		...
		simpleRecursiveModelGroupDefinition = xsdFactory.createXSDModelGroupDefinition();
		simpleRecursiveModelGroupDefinition./*{@link XSDNamedComponent#setName */
		setName /*}*/
		 ("simpleRecursiveModelGroupDefinition");
		...
		modelGroup./*{@link XSDModelGroup#setCompositor(XSDCompositor) */
		setCompositor /*}*/
		...
		simpleRecursiveElementDeclarationReference = xsdFactory.createXSDElementDeclaration();
		simpleRecursiveElementDeclarationReference./*{@link XSDElementDeclaration#setResolvedElementDeclaration */
		setResolvedElementDeclaration /*}*/
		 (prototypeSchema./*{@link XSDConcreteComponent#resolveElementDeclaration(String) */
		...
		/*{@link */
		XSDParticle /*}*/
		simpleRecursiveElementParticle = xsdFactory.createXSDParticle();
		simpleRecursiveElementParticle./*{@link XSDParticle#setContent */
		setContent /*}*/
		 (simpleRecursiveElementDeclarationReference);
		simpleRecursiveElementParticle./*{@link XSDParticle#setMinOccurs(int) */
		setMinOccurs /*}*/
		 (0);
		simpleRecursiveElementParticle./*{@link XSDParticle#setMaxOccurs(int) */
		setMaxOccurs /*}*/
		 (-1);

		// Add the element particle to the model group.
		//
		modelGroup./*{@link XSDModelGroup#getContents */
		getContents /*}*/
		 ().add(simpleRecursiveElementParticle);

		// Create an element wildcard, set the namespace constraint to be other, and the processing to be lax.
		//
		/*{@link */
		XSDWildcard /*}*/
		elementWildcard = xsdFactory.createXSDWildcard();
		elementWildcard./*{@link XSDWildcard#getLexicalNamespaceConstraint */
		getLexicalNamespaceConstraint /*}*/
		 ().add("##other");
		elementWildcard./*{@link XSDWildcard#setProcessContents */
		setProcessContents /*}*/
		 (XSDProcessContents.LAX_LITERAL);
		...
		// Set the model group to be that of the simpleRecursiveModelGroupDefinition.
		//
		simpleRecursiveModelGroupDefinition./*{@link XSDModelGroupDefinition#setModelGroup */
		setModelGroup /*}*/
		 (modelGroup);
		...
		prototypeSchema./*{@link XSDSchema#getContents */
		getContents /*}*/
		 ().add(simpleRecursiveModelGroupDefinition);
	...
	// <!-- begin-initialize-simple-recursive-complex-type-definition -->
	{
		...
		simpleRecursiveComplexTypeDefinition = xsdFactory.createXSDComplexTypeDefinition();
		simpleRecursiveComplexTypeDefinition./*{@link XSDNamedComponent#getName */
		setName /*}*/
		 ("SimpleRecursiveComplexTypeDefinition");
		simpleRecursiveComplexTypeDefinition./*{@link XSDComplexTypeDefinition#setAbstract */
		setAbstract /*}*/
		 (false);
		simpleRecursiveComplexTypeDefinition./*{@link XSDComplexTypeDefinition#getBlock */
		getBlock /*}*/
		 ().add(/*{@link */
		XSDProhibitedSubstitutions /*}*/
		.ALL_LITERAL);
		simpleRecursiveComplexTypeDefinition./*{@link XSDComplexTypeDefinition#getLexicalFinal */
		getLexicalFinal /*}*/
		 ().add(/*{@link */
		XSDComplexFinal /*}*/
		.ALL_LITERAL);
		simpleRecursiveComplexTypeDefinition./*{@link XSDComplexTypeDefinition#setDerivationMethod */
		setDerivationMethod /*}*/
		 (/*{@link */
		XSDDerivationMethod /*}*/
		.RESTRICTION_LITERAL);
		simpleRecursiveComplexTypeDefinition./*{@link XSDComplexTypeDefinition#setMixed */
		setMixed /*}*/
		 (true);
		...
		simpleRecursiveComplexTypeDefinition./*{@link XSDComplexTypeDefinition#setAnnotation */
		setAnnotation /*}*/
		 (annotation);
		...
		/*{@link */
		XSDModelGroupDefinition /*}*/
		simpleRecursiveModelGroupDefinitionReference = xsdFactory.createXSDModelGroupDefinition();
		simpleRecursiveModelGroupDefinitionReference./*{@link XSDModelGroupDefinition#setResolvedModelGroupDefinition */
		setResolvedModelGroupDefinition /*}*/
		 (prototypeSchema./*{@link XSDConcreteComponent#resolveModelGroupDefinition(String) */
		resolveModelGroupDefinition /*}*/
		 ("simpleRecursiveModelGroupDefinition"));
		/*{@link */
		XSDParticle /*}*/
		modelGroupParticle = xsdFactory.createXSDParticle();
		modelGroupParticle./*{@link XSDParticle#setContent */
		setContent /*}*/
		 (simpleRecursiveModelGroupDefinitionReference);
		simpleRecursiveComplexTypeDefinition./*{@link XSDComplexTypeDefinition#setContent */
		setContent /*}*/
		 (modelGroupParticle);
		...
		/*{@link */
		XSDAttributeDeclaration /*}*/
		simpleAttributeDeclarationReference = xsdFactory.createXSDAttributeDeclaration();
		simpleAttributeDeclarationReference./*{@link XSDAttributeDeclaration#setResolvedAttributeDeclaration */
		setResolvedAttributeDeclaration /*}*/
		 (prototypeSchema./*{@link XSDConcreteComponent#resolveAttributeDeclaration */
		resolveAttributeDeclaration /*}*/
		 ("simpleAttributeDeclaration"));
		/*{@link */
		XSDAttributeUse /*}*/
		simpleAttributeUse = xsdFactory.createXSDAttributeUse();
		simpleAttributeUse./*{@link XSDAttributeUse#setContent */
		setContent /*}*/
		 (simpleAttributeDeclarationReference);
		simpleAttributeUse./*{@link XSDAttributeUse#setUse */
		setUse /*}*/
		 (/*{@link */
		XSDAttributeUseCategory /*}*/
		.OPTIONAL_LITERAL);
		simpleRecursiveComplexTypeDefinition./*{@link XSDComplexTypeDefinition#getAttributeContents */
		getAttributeContents /*}*/
		 ().add(simpleAttributeUse);
		...
		/*{@link */
		XSDAttributeGroupDefinition /*}*/
		simpleAttributeGroupDefinitionReference = xsdFactory.createXSDAttributeGroupDefinition();
		simpleAttributeGroupDefinitionReference./*{@link XSDAttributeGroupDefinition#setResolvedAttributeGroupDefinition */
		setResolvedAttributeGroupDefinition /*}*/
		 (prototypeSchema./*{@link XSDConcreteComponent#resolveAttributeGroupDefinition(String) */
		...
		/*{@link */
		XSDWildcard /*}*/
		attributeWildcard = xsdFactory.createXSDWildcard();
		attributeWildcard./*{@link XSDWildcard#getLexicalNamespaceConstraint */
		getLexicalNamespaceConstraint /*}*/
		 ().add("##other");
		simpleRecursiveComplexTypeDefinition./*{@link XSDComplexTypeDefinition#getAttributeWildcardContent */
		...
		appinfo = annotation./*{@link XSDAnnotation#createApplicationInformation */
		createApplicationInformation /*}*/
		 ("http://www.example.com/appinfo");
		annotation./*{@link XSDConcreteComponent#getElement */
		getElement /*}*/
		 ()./*{@link Element#appendChild <em>*/
		appendChild /*</em>}*/
		 (appinfo);
		...
		// Also add the element as the annotation's child.
		//
		Element documentation = annotation./*{@link XSDAnnotation#createUserInformation */
		createUserInformation /*}*/
		 ("http://www.example.com/documentation");
		annotation.getElement().appendChild(documentation);
		documentation./*{@link Element#appendChild <em>*/
		appendChild /*</em>}*/
		 (documentation.getOwnerDocument().createTextNode("A simple recursive complex type definition."));
	...
	// <!-- begin-initialize-simple-recursive-element-declaration -->
	{
		...
		/*{@link */
		XSDElementDeclaration /*}*/
		simpleRecursiveElementDeclaration = xsdFactory.createXSDElementDeclaration();
		simpleRecursiveElementDeclaration./*{@link XSDNamedComponent#setName */
		setName /*}*/
		 ("simpleRecursiveElementDeclaration");
		...
		XSDAnnotation /*}*/
		annotation = xsdFactory.createXSDAnnotation();
		simpleRecursiveElementDeclaration./*{@link XSDElementDeclaration#setAnnotation */
		setAnnotation /*}*/
		 (annotation);

		// Set the element type definition to complex SimpleRecursiveComplexTypeDefinition from this schema.
		//
		simpleRecursiveElementDeclaration./*{@link XSDElementDeclaration#setTypeDefinition */
		setTypeDefinition /*}*/
		 (prototypeSchema./*{@link XSDConcreteComponent#resolveComplexTypeDefinition(String) */
		...
		prototypeSchema./*{@link XSDSchema#getContents */
		getContents /*}*/
		 ().add(simpleRecursiveElementDeclaration);
	...
	// <!-- begin-initialize-simple-attribute-declaration -->
	{
		...
		/*{@link */
		XSDAttributeDeclaration /*}*/
		simpleAttributeDeclaration = xsdFactory.createXSDAttributeDeclaration();
		simpleAttributeDeclaration./*{@link XSDNamedComponent#setName */
		setName /*}*/
		 ("simpleAttributeDeclaration");
		simpleAttributeDeclaration./*{@link XSDAttributeDeclaration#setTypeDefinition */
		setTypeDefinition /*}*/
		 (prototypeSchema.resolveSimpleTypeDefinition(/*{@link #*/
		someOtherSchemaURI /*}*/
		, "someOtherTypeDefinition"));
		simpleAttributeDeclaration./*{@link XSDAttributeDeclaration#setConstraint */
		setConstraint /*}*/
		 (/*{@link */
		XSDConstraint /*}*/
		.DEFAULT_LITERAL);
		simpleAttributeDeclaration./*{@link XSDAttributeDeclaration#setLexicalValue */
		setLexicalValue /*}*/
		 ("defaultValue");
		...
		prototypeSchema./*{@link XSDSchema#getContents */
		getContents /*}*/
		 ().add(simpleAttributeDeclaration);
	...
	// <!-- begin-initialize-simple-element-declaration-with-anonymous-type -->
	{
		...
		/*{@link */
		XSDElementDeclaration /*}*/
		simpleElementDeclarationWithAnonymousType = xsdFactory.createXSDElementDeclaration();
		simpleElementDeclarationWithAnonymousType./*{@link XSDNamedComponent#setName */
		setName /*}*/
		 ("simpleElementWithAnonymousType");
		...
		XSDAnnotation /*}*/
		annotation = xsdFactory.createXSDAnnotation();
		simpleElementDeclarationWithAnonymousType./*{@link XSDElementDeclaration#setAnnotation */
		setAnnotation /*}*/
		 (annotation);
		...
		anonymousSimpleTypeDefinition = xsdFactory.createXSDSimpleTypeDefinition();
		anonymousSimpleTypeDefinition./*{@link XSDSimpleTypeDefinition#setBaseTypeDefinition */
		setBaseTypeDefinition /*}*/
		 (prototypeSchema./*{@link XSDSchema#getSchemaForSchema */
		getSchemaForSchema /*}*/
		 ()./*{@link XSDConcreteComponent#resolveSimpleTypeDefinition */
		resolveSimpleTypeDefinition /*}*/
		 ("string"));
		...
		/*{@link */
		XSDPatternFacet /*}*/
		xsdPatternFacet = xsdFactory.createXSDPatternFacet();
		xsdPatternFacet./*{@link XSDPatternFacet#setLexicalValue */
		setLexicalValue /*}*/
		 ("\\d\\d..");
		anonymousSimpleTypeDefinition./*{@link XSDSimpleTypeDefinition#getFacetContents */
		getFacetContents /*}*/
		 ().add(xsdPatternFacet);
		...
		setAnnotation /*}*/
		 (annotation);
		simpleElementDeclarationWithAnonymousType./*{@link XSDElementDeclaration#setAnonymousTypeDefinition */
		setAnonymousTypeDefinition /*}*/
		 (anonymousSimpleTypeDefinition);
		simpleElementDeclarationWithAnonymousType./*{@link XSDElementDeclaration#setConstraint */
		setConstraint /*}*/
		 (/*{@link */
		XSDConstraint /*}*/
		.FIXED_LITERAL);
		simpleElementDeclarationWithAnonymousType./*{@link XSDElementDeclaration#setLexicalValue */
		setLexicalValue /*}*/
		 ("12ab");
		...
		prototypeSchema./*{@link XSDSchema#getContents */
		getContents /*}*/
		 ().add(simpleElementDeclarationWithAnonymousType);
	...
	// <!-- begin-initialize-simple-type-definition -->
	{
		...
		/*{@link */
		XSDSimpleTypeDefinition /*}*/
		simpleTypeDefinition = xsdFactory.createXSDSimpleTypeDefinition();
		simpleTypeDefinition./*{@link XSDNamedComponent#setName */
		setName /*}*/
		 ("SimpleTypeDefinition");
		simpleTypeDefinition./*{@link XSDSimpleTypeDefinition#setBaseTypeDefinition */
		setBaseTypeDefinition /*}*/
		 (prototypeSchema./*{@link XSDSchema#getSchemaForSchema */
		getSchemaForSchema /*}*/
		 ()./*{@link XSDConcreteComponent#resolveSimpleTypeDefinition */
		...
		XSDAnnotation /*}*/
		annotation = xsdFactory.createXSDAnnotation();
		simpleTypeDefinition./*{@link XSDElementDeclaration#setAnnotation */
		setAnnotation /*}*/
		 (annotation);
		...
		xsdMaxInclusiveFacet = xsdFactory.createXSDMaxInclusiveFacet();
		xsdMaxInclusiveFacet./*{@link XSDMaxInclusiveFacet#setLexicalValue */
		setLexicalValue /*}*/
		 ("100");
		simpleTypeDefinition./*{@link XSDSimpleTypeDefinition#getFacetContents */
		getFacetContents /*}*/
		 ().add(xsdMaxInclusiveFacet);

		// Add the simple type to the schema
		//
		prototypeSchema./*{@link XSDSchema#getContents */
		getContents /*}*/
		 ().add(simpleTypeDefinition);
	...
	// <!-- begin-initialize-simple-list-type-definition -->
	{
		...
		/*{@link */
		XSDSimpleTypeDefinition /*}*/
		simpleListTypeDefinition = xsdFactory.createXSDSimpleTypeDefinition();
		simpleListTypeDefinition./*{@link XSDNamedComponent#setName */
		setName /*}*/
		 ("SimpleListTypeDefinition");
		simpleListTypeDefinition./*{@link XSDSimpleTypeDefinition#setItemTypeDefinition */
		...
		XSDAnnotation /*}*/
		annotation = xsdFactory.createXSDAnnotation();
		simpleListTypeDefinition./*{@link XSDElementDeclaration#setAnnotation */
		setAnnotation /*}*/
		 (annotation);
	...
	// <!-- begin-initialize-simple-union-type-definition -->
	{
		...
		/*{@link */
		XSDSimpleTypeDefinition /*}*/
		simpleUnionTypeDefinition = xsdFactory.createXSDSimpleTypeDefinition();
		simpleUnionTypeDefinition./*{@link XSDNamedComponent#setName */
		setName /*}*/
		 ("SimpleUnionTypeDefinition");
		simpleUnionTypeDefinition./*{@link XSDSimpleTypeDefinition#getMemberTypeDefinitions */
		getMemberTypeDefinitions /*}*/
		 ().add(prototypeSchema.
		/*{@link XSDSchema#getSchemaForSchema */
		getSchemaForSchema /*}*/
		 ()./*{@link XSDConcreteComponent#resolveSimpleTypeDefinition */
		resolveSimpleTypeDefinition /*}*/
		 ("integer"));
		...
		XSDAnnotation /*}*/
		annotation = xsdFactory.createXSDAnnotation();
		simpleUnionTypeDefinition./*{@link XSDElementDeclaration#setAnnotation */
		setAnnotation /*}*/
		 (annotation);
	...
	// <!-- begin-initialize-fancy-list-type-definition -->
	{
		...
		/*{@link */
		XSDSimpleTypeDefinition /*}*/
		fancyListTypeDefinition = xsdFactory.createXSDSimpleTypeDefinition();
		fancyListTypeDefinition./*{@link XSDNamedComponent#setName */
		setName /*}*/
		 ("FancyListTypeDefinition");
		...
		//
		XSDSimpleTypeDefinition firstMemberTypeDefinition = xsdFactory.createXSDSimpleTypeDefinition();
		firstMemberTypeDefinition./*{@link XSDSimpleTypeDefinition#setBaseTypeDefinition */
		setBaseTypeDefinition /*}*/
		 (prototypeSchema./*{@link XSDSchema#getSchemaForSchema */
		getSchemaForSchema /*}*/
		 ()./*{@link XSDConcreteComponent#resolveSimpleTypeDefinition */
		...
		xsdEnumerationFacet./*{@link XSDConstrainingFacet#setLexicalValue */
		setLexicalValue /*}*/
		 ("unknown");
		firstMemberTypeDefinition./*{@link XSDSimpleTypeDefinition#getFacetContents */
		getFacetContents /*}*/
		 ().add(xsdEnumerationFacet);

		// Add the anonymous member to the contents <b>and</b> the member type definitions of unionTypeDefinition.
		//
		unionTypeDefinition./*{@link XSDSimpleTypeDefinition#getContents */
		getContents /*}*/
		 ().add(firstMemberTypeDefinition);
		unionTypeDefinition./*{@link XSDSimpleTypeDefinition#getMemberTypeDefinitions */
		getMemberTypeDefinitions /*}*/
		 ().add(firstMemberTypeDefinition);
		...
		//
		XSDSimpleTypeDefinition secondMemberTypeDefinition = xsdFactory.createXSDSimpleTypeDefinition();
		secondMemberTypeDefinition.setBaseTypeDefinition(prototypeSchema.getSchemaForSchema().resolveSimpleTypeDefinition("decimal"));
	...
	// <!-- begin-initialize-simple-content-complex-type-definition -->
	{
		...
		simpleContentComplexTypeDefinition./*{@link XSDNamedComponent#setName */
		setName /*}*/
		 ("SimpleContentComplexTypeDefinition");
		simpleContentComplexTypeDefinition./*{@link XSDComplexTypeDefinition#setDerivationMethod */
		setDerivationMethod /*}*/
		 (/*{@link */
		XSDDerivationMethod /*}*/
		.EXTENSION_LITERAL);
		...
		XSDAnnotation /*}*/
		annotation = xsdFactory.createXSDAnnotation();
		simpleContentComplexTypeDefinition./*{@link XSDElementDeclaration#setAnnotation */
		setAnnotation /*}*/
		 (annotation);
		...
		//
		XSDSimpleTypeDefinition anonymousSimpleTypeDefinition = xsdFactory.createXSDSimpleTypeDefinition();
		simpleContentComplexTypeDefinition./*{@link XSDSimpleTypeDefinition#setBaseTypeDefinition */
		setBaseTypeDefinition /*}*/
		 (prototypeSchema./*{@link XSDSchema#getSchemaForSchema */
		getSchemaForSchema /*}*/
		 ()./*{@link XSDConcreteComponent#resolveSimpleTypeDefinition */
		resolveSimpleTypeDefinition /*}*/
		 ("string"));
		simpleContentComplexTypeDefinition./*{@link XSDComplexTypeDefinition#setContent */
		setContent /*}*/
		 (anonymousSimpleTypeDefinition);
		...
		simpleAttributeDeclarationReference./*{@link XSDAttributeDeclaration#setResolvedAttributeDeclaration */
		setResolvedAttributeDeclaration /*}*/
		 (prototypeSchema./*{@link XSDConcreteComponent#resolveAttributeDeclaration(String) */
		resolveAttributeDeclaration /*}*/
		 ("simpleAttributeDeclaration"));
		...
		setContent /*}*/
		 (simpleAttributeDeclarationReference);
		simpleAttributeUse.setUse(/*{@link */
		XSDAttributeUseCategory /*}*/
		.OPTIONAL_LITERAL);
		simpleContentComplexTypeDefinition./*{@link XSDComplexTypeDefinition#getAttributeContents */
		getAttributeContents /*}*/
		 ().add(simpleAttributeUse);
		...
		prototypeSchema./*{@link XSDSchema#getContents */
		getContents /*}*/
		 ().add(simpleContentComplexTypeDefinition);
	 ...
	 *  country.{@link XSDAttributeDeclaration#setConstraint(XSDConstraint) setConstraint}({@link XSDConstraint}.FIXED_LITERAL);
	 *  country.{@link XSDAttributeDeclaration#setLexicalValue setLexicalValue}("US");
	...
	// <!-- begin-purchase-order -->
	{
		...
		// which is recommend, this is the recommended qualifier.
		//
		xsdSchema./*{@link XSDSchema#setSchemaForSchemaQNamePrefix */
		setSchemaForSchemaQNamePrefix /*}*/
		 ("xsd");

		// Set the target namespace.
		//
		xsdSchema./*{@link XSDSchema#setTargetNamespace */
		setTargetNamespace /*}*/
		 ("http://nist.gov/po.xsd");

		// Choose the prefix used for this schema's namespace and the {@link XSDSchema#getSchemaForSchema schema for schema}'s namespace.
		//
		Map qNamePrefixToNamespaceMap = xsdSchema./*{@link XSDSchema#getQNamePrefixToNamespaceMap */
		getQNamePrefixToNamespaceMap /*}*/
		 ();
		qNamePrefixToNamespaceMap.put("po", xsdSchema.getTargetNamespace());
		qNamePrefixToNamespaceMap.put(xsdSchema.getSchemaForSchemaQNamePrefix(), /*{@link */
		XSDConstants /*}*/
		.SCHEMA_FOR_SCHEMA_URI_2001);
		...
		xsdSchema./*{@link XSDSchema#getContents */
		getContents /*}*/
		 ().add(xsdAnnotation);
		...
		/*{@link */
		Element /* <em>Element</em>}*/
		documentation = xsdAnnotation./*{@link XSDAnnotation#createUserInformation */
		createUserInformation /*}*/
		 (null);

		// Use the DOM API to set the lang attribute and content of the documentation.
		//
		documentation./*{@link Element#setAttributeNS <em>*/
		setAttributeNS /*</em>}*/
		 (XSDConstants.XML_NAMESPACE_URI_1998, "xml:lang", "en");
		String text = "Purchase order schema for Example.com.\nCopyright 2000 Example.com. All rights reserved.";
		documentation./*{@link Element#appendChild <em>*/
		appendChild /*</em>}*/
		 (documentation.getOwnerDocument().createTextNode(text));

		// Use the DOM API to add the documentation to the element of the annotation.
		//
		xsdAnnotation./*{@link XSDAnnotation#getElement */
		getElement /*}*/
		 ().appendChild(documentation);
		...
		/*{@link */
		XSDElementDeclaration /*}*/
		purchaseOrder = xsdFactory.createXSDElementDeclaration();
		purchaseOrder./*{@link XSDNamedComponent#setName */
		setName /*}*/
		 ("purchaseOrder");
		purchaseOrder./*{@link XSDElementDeclaration#setTypeDefinition */
		setTypeDefinition /*}*/
		 (xsdSchema./*{@link XSDConcreteComponent#resolveComplexTypeDefinition(String) */
		resolveComplexTypeDefinition /*}*/
		 ("PurchaseOrderType"));
		xsdSchema.getContents().add(purchaseOrder);
		...
		XSDElementDeclaration comment = xsdFactory.createXSDElementDeclaration();
		comment.setName("comment");
		comment.setTypeDefinition(xsdSchema.getSchemaForSchema()./*{@link XSDConcreteComponent#resolveSimpleTypeDefinition(String) */
		resolveSimpleTypeDefinition /*}*/
		 ("string"));
		xsdSchema.getContents().add(comment);
		...
		/*{@link */
		XSDComplexTypeDefinition /*}*/
		purchaseOrderType = xsdFactory.createXSDComplexTypeDefinition();
		purchaseOrderType./*{@link XSDNamedComponent#setName */
		setName /*}*/
		 ("PurchaseOrderType");
		...
		/*{@link */
		XSDModelGroup /*}*/
		purchaseOrderTypeSequence = xsdFactory.createXSDModelGroup();
		purchaseOrderTypeSequence./*{@link XSDModelGroup#setCompositor */
		setCompositor /*}*/
		 (XSDCompositor.SEQUENCE_LITERAL);
		/*{@link */
		XSDParticle /*}*/
		purchaseOrderTypeParticle = xsdFactory.createXSDParticle();
		purchaseOrderTypeParticle./*{@link XSDParticle#setContent */
		setContent /*}*/
		 (purchaseOrderTypeSequence);
		...
		XSDParticle shipToParticle = xsdFactory.createXSDParticle();
		shipToParticle.setContent(shipTo);
		purchaseOrderTypeSequence./*{@link XSDModelGroup#getContents */
		getContents /*}*/
		 ().add(shipToParticle);
		...
		//
		XSDElementDeclaration commentRef = xsdFactory.createXSDElementDeclaration();
		commentRef./*{@link XSDElementDeclaration#setResolvedElementDeclaration */
		setResolvedElementDeclaration /*}*/
		 (xsdSchema./*{@link XSDConcreteComponent#resolveElementDeclaration(String) */
		resolveElementDeclaration /*}*/
		 ("comment"));
		XSDParticle commentRefParticle = xsdFactory.createXSDParticle();
		commentRefParticle./*{@link XSDParticle#setMinOccurs(int) */
		setMinOccurs /*}*/
		 (0);
		commentRefParticle.setContent(commentRef);
		purchaseOrderTypeSequence.getContents().add(commentRefParticle);
		...
		// Set the completed content particle to be the content of the PurchaseOrderType.
		//
		purchaseOrderType./*{@link XSDComplexTypeDefinition#setContent */
		setContent /*}*/
		 (purchaseOrderTypeParticle);
		...
		/*{@link */
		XSDAttributeDeclaration /*}*/
		orderDate = xsdFactory.createXSDAttributeDeclaration();
		orderDate./*{@link XSDNamedComponent#setName */
		setName /*}*/
		 ("orderDate");
		orderDate./*{@link XSDAttributeDeclaration#setTypeDefinition */
		setTypeDefinition /*}*/
		 (xsdSchema.getSchemaForSchema().resolveSimpleTypeDefinition("date"));
		/*{@link */
		XSDAttributeUse /*}*/
		orderDateAttributeUse = xsdFactory.createXSDAttributeUse();
		orderDateAttributeUse./*{@link XSDAttributeUse#setContent */
		setContent /*}*/
		 (orderDate);
		purchaseOrderType./*{@link XSDComplexTypeDefinition#getAttributeContents */
		getAttributeContents /*}*/
		 ().add(orderDateAttributeUse);
		...
		country.setName("country");
		country.setTypeDefinition(xsdSchema.getSchemaForSchema().resolveSimpleTypeDefinition("NMTOKEN"));
		country./*{@link XSDAttributeDeclaration#setConstraint(XSDConstraint) */
		setConstraint /*}*/
		 (/*{@link */
		XSDConstraint /*}*/
		.FIXED_LITERAL);
		country./*{@link XSDAttributeDeclaration#setLexicalValue */
		setLexicalValue /*}*/
		 ("US");
		XSDAttributeUse countryAttributeUse = xsdFactory.createXSDAttributeUse();
		countryAttributeUse.setContent(country);
		...
		// Set the completed anonymous type of the item element.
		//
		item./*{@link XSDElementDeclaration#setAnonymousTypeDefinition */
		setAnonymousTypeDefinition /*}*/
	 ...
	 *    {@link Resource} resource = new {@link XSDResourceImpl}(URI.createDeviceURI(schemaURI));
	...
	// <!-- begin-save-purchase-order -->
	{
		...
		try {
			...
			resource = new /*{@link */
			XSDResourceImpl /*}*/
			 (URI.createURI(schemaURI));
			resource./*{@link Resource#getContents */
			getContents /*}*/
			 ().add(purchaseOrderSchema);
			resourceSet./*{@link ResourceSet#getResources() */
			getResources() /*}*/
			.add(resource);
			resource./*{@link Resource#save(java.util.Map) */
			save /*}*/
	 ...
	 *    {@link XSDResourceImpl} xsdSchemaResource = (XSDResourceImpl)resourceSet.{@link ResourceSet#getResource getResource}(URI.createDeviceURI(xsdSchemaURI), true);
	 *
	 ...
	 *            XSDPlugin.{@link XSDPlugin#getString(String,Object[]) getString}("_UI_XSDDiagnosticSeverity_" + xsdDiagnostic.{@link XSDDiagnostic#getSeverity getSeverity}());
	 *          System.out.println
	 *            (XSDPlugin.getString
...
//			/*{@link */
//			XSDResourceImpl /*}*/
//			xsdSchemaResource = (XSDResourceImpl) resourceSet./*{@link ResourceSet#getResource */
//			getResource /*}*/
//			 (URI.createURI(xsdSchemaURI), true);
//
//			// Iterate over all the resources, i.e., the main resource 
//			// and those that have been included, imported, or redefined.
//			//
//			for (Iterator resources = resourceSet./*{@link ResourceSet#getResources */
//				getResources /*}*/
...
//					/*{@link */
//					XSDSchema /*}*/
//					xsdSchema = xsdResource./*{@link XSDResourceImpl#getSchema */
//					getSchema /*}*/
//					 ();
//					System.out.println("\n<" + "!-- *** " + xsdResource./*{@link Resource#getURI */
//					getURI /*}*/
//					 () + " *** -->\n");
//					/*{@link #printComponent */
//					printComponent /*}*/
//					 (System.out, xsdSchema);
//
//					// If there are no errors from just trying to parse a DOM, 
//					// validate the schema.
//					//
//					if (xsdSchema./*{@link XSDSchema#getAllDiagnostics */
//						getAllDiagnostics /*}*/
//						 ().isEmpty()) {
//						xsdSchema.validate();
//					}
...
//						/*{@link */
//						XSDDiagnostic /*}*/
//						xsdDiagnostic = (XSDDiagnostic) diagnostics.next();
//						String localizedSeverity = XSDPlugin.
//						/*{@link XSDPlugin#getString(String,Object[]) */
//						getString /*}*/
//						 ("_UI_XSDDiagnosticSeverity_" + xsdDiagnostic./*{@link XSDDiagnostic#getSeverity */
//						getSeverity /*}*/
//						 ());
//						System
//							.out
//							.println(
//								XSDPlugin
//								.getString("_UI_DiagnosticFileLineColumn_message", new Object[] { localizedSeverity, xsdDiagnostic.
//							/*{@link XSDDiagnostic#getLocationURI */
//							getLocationURI /*}*/
//							 (), new Integer(xsdDiagnostic./*{@link XSDDiagnostic#getLine */
//							getLine /*}*/
//							 ()), new Integer(xsdDiagnostic./*{@link XSDDiagnostic#getColumn */
//							getColumn /*}*/
//							 ())}));
//
//						System.out.println(xsdDiagnostic./*{@link XSDDiagnostic#getMessage */
//						getMessage /*}*/
//						 ());
//					}
//				}
...
//	}
	...
	// <!-- begin-print-component -->
	{
		...
		/*{@link */
		Element /*}*/
		element = xsdConcreteComponent./*{@link XSDConcreteComponent#getElement */
		getElement /*}*/
		 ();
		if (element == null) {
			xsdConcreteComponent./*{@link XSDConcreteComponent#updateElement */
			updateElement /*}*/
			 ();
		}
		...
		if (element != null) {
			try {
				/*{@link */
				OutputFormat /*}*/
				outputFormat = new OutputFormat(element.getOwnerDocument());
				outputFormat.setLineWidth(80);
				outputFormat.setIndenting(true);
				outputFormat.setIndent(4);
				outputFormat.setPreserveSpace(false);
	...
	// <!-- begin-create-schema -->
	{
		...
		// Test if the element is really a schema element.
		//
		if (element.getLocalName().equals("schema") && /*{@link */
			XSDConstants /*}*/
			./*{@link XSDConstants#isSchemaForSchemaNamespace */
			...
			/*{@link */
			XSDSchema /*}*/
			xsdSchema = XSDFactory.eINSTANCE./*{@link XSDFactory#createXSDSchema */
			createXSDSchema /*}*/
			 ();
			...
			// This it will build the corresponding component structure.
			//
			xsdSchema./*{@link XSDConcreteComponent#setElement */
			setElement /*}*/
			 (element);
	 ...
	 *    //
	 *    {@link XSDResourceImpl} xsdSchemaResource = (XSDResourceImpl)resourceSet.getResource(URI.createDeviceURI(xsdSchemaURI), true);
	 *
	 *    // Iterate over all the resources, i.e., the main resource 
	 *    // and those that have been included, imported, or redefined.
	 *    //
	...
	// <!-- begin-trace-loading -->
	{
		...
		try {
			...
			ResourceSetImpl /*}*/
			 () {
				public Resource getResource(URI uri, boolean loadOnDemand) {
					Resource result = super./*{@link ResourceSet#getResource */
					getResource /*}*/
					 (uri, true);
					System.out.println("<" + "!-- loaded: " + uri + " --> " + result);
					return result;
			...
			/*{@link */
			XSDResourceImpl /*}*/
			xsdSchemaResource = (XSDResourceImpl) resourceSet.getResource(URI.createURI(xsdSchemaURI), true);
			...
			for (Iterator resources = resourceSet./*{@link ResourceSet#getResources */
				...
				if (resource instanceof XSDResourceImpl) {
					...
					getSchema /*}*/
					 ();
					for (Iterator contents = xsdSchema./*{@link XSDSchema#getContents */
						getContents /*}*/
						 ().iterator(); contents.hasNext();) {
						/*{@link */
						XSDSchemaContent /*}*/
						xsdSchemaContent = (XSDSchemaContent) contents.next();
						if (xsdSchemaContent instanceof /*{@link */
							XSDSchemaDirective /*}*/
							) {
							// Check if the directive resolved to a schema.
							//
							XSDSchemaDirective xsdSchemaDirective = (XSDSchemaDirective) xsdSchemaContent;
							if (xsdSchemaDirective./*{@link XSDSchemaDirective#getResolvedSchema */
								getResolvedSchema /*}*/
								 () == null) {
								System.out.println("Unresolved schema in " + xsdResource./*{@link Resource#getURI */
								getURI /*}*/
								 ());
								/*{@link #printComponent */
								printComponent /*}*/
								 (System.out, xsdSchemaDirective);
							}
						}
					}
				}
