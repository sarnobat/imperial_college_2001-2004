...
public class DataPopulator {
	 ...
	 */
	public int populateDatabaseWithRoot(Element root) {
		//PICKUP
	 ...
	 */
	public int populateDatabaseWithElement(Element element, int parentId, int order) {
		...
		// Determine which table is its parent (not necessarily the parent element's data table (e.g. if it's a generalization))
		
		//PICKUP String referringTableName = databaseManager.getReferringTable();
